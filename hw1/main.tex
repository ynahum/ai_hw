...
Moreover, the MD doesn't take into consideration the actions of pickup and drop-off so it's even strictly less then the cost to go (and we could even create a better informed heuristic).\qed
